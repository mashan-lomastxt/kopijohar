      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-header bg-default">
            <div class="row">
              <div class="col-md-6">
                <h1 class="font-weight-bold mb-3 text-white">Daftar Produk</h1>
              </div>
              <div class="col-md-6">
                <label class="mt-0 font-weight-bold mb-3 text-white">Kategori</label>
      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body bg-default">
            <h3 class="font-weight-bold text-white">Detail Pesanan</h3>
            <div class="table-responsive">
              ...
              <form>
                <div class="mt-3">
                  <button class="btn btn-success btn-sm btn-block" type="submit">Add To Cart</button>
                </div>
              </form>
            </div>
          </div>
